...
//synthesis_resources = cyclone10lp_rublock 1 lpm_counter 2 reg 65 
...
`endif
	...
	always @ ( posedge clock or  posedge reset)
		if (reset == 1'b1) dffe7a[0:0] <= 1'b0;
			...
			else  dffe7a[0:0] <= ((shift_reg_load_enable & ((((param[2] & (~ param[1])) & (~ param[0])) & data_in[10]) | ((~ ((param[2] & (~ param[1])) & (~ param[0]))) & data_in[0]))) | ((~ shift_reg_load_enable) & dffe7a[1:1]));
	// synopsys translate_off
	initial
		dffe7a[1:1] = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge reset)
		if (reset == 1'b1) dffe7a[1:1] <= 1'b0;
			...
			else  dffe7a[1:1] <= ((shift_reg_load_enable & ((((param[2] & (~ param[1])) & (~ param[0])) & data_in[11]) | ((~ ((param[2] & (~ param[1])) & (~ param[0]))) & data_in[1]))) | ((~ shift_reg_load_enable) & dffe7a[2:2]));
	// synopsys translate_off
	initial
		dffe7a[2:2] = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge reset)
		if (reset == 1'b1) dffe7a[2:2] <= 1'b0;
			...
			else  dffe7a[2:2] <= ((shift_reg_load_enable & ((((param[2] & (~ param[1])) & (~ param[0])) & data_in[12]) | ((~ ((param[2] & (~ param[1])) & (~ param[0]))) & data_in[2]))) | ((~ shift_reg_load_enable) & dffe7a[3:3]));
	// synopsys translate_off
	initial
		dffe7a[3:3] = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge reset)
		if (reset == 1'b1) dffe7a[3:3] <= 1'b0;
			...
			else  dffe7a[3:3] <= ((shift_reg_load_enable & ((((param[2] & (~ param[1])) & (~ param[0])) & data_in[13]) | ((~ ((param[2] & (~ param[1])) & (~ param[0]))) & data_in[3]))) | ((~ shift_reg_load_enable) & dffe7a[4:4]));
	// synopsys translate_off
	initial
		dffe7a[4:4] = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge reset)
		if (reset == 1'b1) dffe7a[4:4] <= 1'b0;
			...
			else  dffe7a[4:4] <= ((shift_reg_load_enable & ((((param[2] & (~ param[1])) & (~ param[0])) & data_in[14]) | ((~ ((param[2] & (~ param[1])) & (~ param[0]))) & data_in[4]))) | ((~ shift_reg_load_enable) & dffe7a[5:5]));
	// synopsys translate_off
	initial
		dffe7a[5:5] = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge reset)
		if (reset == 1'b1) dffe7a[5:5] <= 1'b0;
			...
			else  dffe7a[5:5] <= ((shift_reg_load_enable & ((((param[2] & (~ param[1])) & (~ param[0])) & data_in[15]) | ((~ ((param[2] & (~ param[1])) & (~ param[0]))) & data_in[5]))) | ((~ shift_reg_load_enable) & dffe7a[6:6]));
	// synopsys translate_off
	initial
		dffe7a[6:6] = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge reset)
		if (reset == 1'b1) dffe7a[6:6] <= 1'b0;
			...
			else  dffe7a[6:6] <= ((shift_reg_load_enable & ((((param[2] & (~ param[1])) & (~ param[0])) & data_in[16]) | ((~ ((param[2] & (~ param[1])) & (~ param[0]))) & data_in[6]))) | ((~ shift_reg_load_enable) & dffe7a[7:7]));
	// synopsys translate_off
	initial
		dffe7a[7:7] = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge reset)
		if (reset == 1'b1) dffe7a[7:7] <= 1'b0;
			...
			else  dffe7a[7:7] <= ((shift_reg_load_enable & ((((param[2] & (~ param[1])) & (~ param[0])) & data_in[17]) | ((~ ((param[2] & (~ param[1])) & (~ param[0]))) & data_in[7]))) | ((~ shift_reg_load_enable) & dffe7a[8:8]));
	// synopsys translate_off
	initial
		dffe7a[8:8] = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge reset)
		if (reset == 1'b1) dffe7a[8:8] <= 1'b0;
			...
			else  dffe7a[8:8] <= ((shift_reg_load_enable & ((((param[2] & (~ param[1])) & (~ param[0])) & data_in[18]) | ((~ ((param[2] & (~ param[1])) & (~ param[0]))) & data_in[8]))) | ((~ shift_reg_load_enable) & dffe7a[9:9]));
	// synopsys translate_off
	initial
		dffe7a[9:9] = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge reset)
		if (reset == 1'b1) dffe7a[9:9] <= 1'b0;
			...
			else  dffe7a[9:9] <= ((shift_reg_load_enable & ((((param[2] & (~ param[1])) & (~ param[0])) & data_in[19]) | ((~ ((param[2] & (~ param[1])) & (~ param[0]))) & data_in[9]))) | ((~ shift_reg_load_enable) & dffe7a[10:10]));
	// synopsys translate_off
	initial
		dffe7a[10:10] = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge reset)
		if (reset == 1'b1) dffe7a[10:10] <= 1'b0;
			...
			else  dffe7a[10:10] <= ((shift_reg_load_enable & ((((param[2] & (~ param[1])) & (~ param[0])) & data_in[20]) | ((~ ((param[2] & (~ param[1])) & (~ param[0]))) & data_in[10]))) | ((~ shift_reg_load_enable) & dffe7a[11:11]));
	// synopsys translate_off
	initial
		dffe7a[11:11] = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge reset)
		if (reset == 1'b1) dffe7a[11:11] <= 1'b0;
			...
			else  dffe7a[11:11] <= ((shift_reg_load_enable & ((((param[2] & (~ param[1])) & (~ param[0])) & data_in[21]) | ((~ ((param[2] & (~ param[1])) & (~ param[0]))) & data_in[11]))) | ((~ shift_reg_load_enable) & dffe7a[12:12]));
	// synopsys translate_off
	initial
		dffe7a[12:12] = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge reset)
		if (reset == 1'b1) dffe7a[12:12] <= 1'b0;
			...
			else  dffe7a[12:12] <= ((shift_reg_load_enable & ((((param[2] & (~ param[1])) & (~ param[0])) & data_in[22]) | ((~ ((param[2] & (~ param[1])) & (~ param[0]))) & data_in[12]))) | ((~ shift_reg_load_enable) & dffe7a[13:13]));
	// synopsys translate_off
	initial
		dffe7a[13:13] = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge reset)
		if (reset == 1'b1) dffe7a[13:13] <= 1'b0;
			...
			else  dffe7a[13:13] <= ((shift_reg_load_enable & ((((param[2] & (~ param[1])) & (~ param[0])) & data_in[23]) | ((~ ((param[2] & (~ param[1])) & (~ param[0]))) & data_in[13]))) | ((~ shift_reg_load_enable) & dffe7a[14:14]));
	// synopsys translate_off
	initial
		dffe7a[14:14] = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge reset)
		if (reset == 1'b1) dffe7a[14:14] <= 1'b0;
			...
			else  dffe7a[14:14] <= ((shift_reg_load_enable & ((((param[2] & (~ param[1])) & (~ param[0])) & data_in[24]) | ((~ ((param[2] & (~ param[1])) & (~ param[0]))) & data_in[14]))) | ((~ shift_reg_load_enable) & dffe7a[15:15]));
	// synopsys translate_off
	initial
		dffe7a[15:15] = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge reset)
		if (reset == 1'b1) dffe7a[15:15] <= 1'b0;
			...
			else  dffe7a[15:15] <= ((shift_reg_load_enable & ((((param[2] & (~ param[1])) & (~ param[0])) & data_in[25]) | ((~ ((param[2] & (~ param[1])) & (~ param[0]))) & data_in[15]))) | ((~ shift_reg_load_enable) & dffe7a[16:16]));
	// synopsys translate_off
	initial
		dffe7a[16:16] = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge reset)
		if (reset == 1'b1) dffe7a[16:16] <= 1'b0;
			...
			else  dffe7a[16:16] <= ((shift_reg_load_enable & ((((param[2] & (~ param[1])) & (~ param[0])) & data_in[26]) | ((~ ((param[2] & (~ param[1])) & (~ param[0]))) & data_in[16]))) | ((~ shift_reg_load_enable) & dffe7a[17:17]));
	// synopsys translate_off
	initial
		dffe7a[17:17] = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge reset)
		if (reset == 1'b1) dffe7a[17:17] <= 1'b0;
			...
			else  dffe7a[17:17] <= ((shift_reg_load_enable & ((((param[2] & (~ param[1])) & (~ param[0])) & data_in[27]) | ((~ ((param[2] & (~ param[1])) & (~ param[0]))) & data_in[17]))) | ((~ shift_reg_load_enable) & dffe7a[18:18]));
	// synopsys translate_off
	initial
		dffe7a[18:18] = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge reset)
		if (reset == 1'b1) dffe7a[18:18] <= 1'b0;
			...
			else  dffe7a[18:18] <= ((shift_reg_load_enable & ((((param[2] & (~ param[1])) & (~ param[0])) & data_in[28]) | ((~ ((param[2] & (~ param[1])) & (~ param[0]))) & data_in[18]))) | ((~ shift_reg_load_enable) & dffe7a[19:19]));
	// synopsys translate_off
	initial
		dffe7a[19:19] = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge reset)
		if (reset == 1'b1) dffe7a[19:19] <= 1'b0;
			...
			else  dffe7a[19:19] <= ((shift_reg_load_enable & ((((param[2] & (~ param[1])) & (~ param[0])) & data_in[29]) | ((~ ((param[2] & (~ param[1])) & (~ param[0]))) & data_in[19]))) | ((~ shift_reg_load_enable) & dffe7a[20:20]));
	// synopsys translate_off
	initial
		dffe7a[20:20] = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge reset)
		if (reset == 1'b1) dffe7a[20:20] <= 1'b0;
			...
			else  dffe7a[20:20] <= ((shift_reg_load_enable & ((((param[2] & (~ param[1])) & (~ param[0])) & data_in[30]) | ((~ ((param[2] & (~ param[1])) & (~ param[0]))) & data_in[20]))) | ((~ shift_reg_load_enable) & dffe7a[21:21]));
	// synopsys translate_off
	initial
		dffe7a[21:21] = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge reset)
		if (reset == 1'b1) dffe7a[21:21] <= 1'b0;
			...
			else  dffe7a[21:21] <= ((shift_reg_load_enable & ((((param[2] & (~ param[1])) & (~ param[0])) & data_in[31]) | ((~ ((param[2] & (~ param[1])) & (~ param[0]))) & data_in[21]))) | ((~ shift_reg_load_enable) & dffe7a[22:22]));
	// synopsys translate_off
	initial
		dffe7a[22:22] = 0;
	// synopsys translate_on
	...
	always @ ( posedge clock or  posedge reset)
		if (reset == 1'b1) dffe7a[28:28] <= 1'b0;
			...
			else  dffe7a[28:28] <= ((~ shift_reg_load_enable) & dffe7a[29:29]);
	// synopsys translate_off
	initial
		dffe7a[29:29] = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge reset)
		if (reset == 1'b1) dffe7a[29:29] <= 1'b0;
		else if  (wire_dffe7a_ena[29:29] == 1'b1) 
			if (shift_reg_clear == 1'b1) dffe7a[29:29] <= 1'b0;
			else  dffe7a[29:29] <= ((~ shift_reg_load_enable) & dffe7a[30:30]);
	// synopsys translate_off
	initial
		dffe7a[30:30] = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge reset)
		if (reset == 1'b1) dffe7a[30:30] <= 1'b0;
		else if  (wire_dffe7a_ena[30:30] == 1'b1) 
			if (shift_reg_clear == 1'b1) dffe7a[30:30] <= 1'b0;
			else  dffe7a[30:30] <= ((~ shift_reg_load_enable) & dffe7a[31:31]);
	// synopsys translate_off
	initial
		dffe7a[31:31] = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge reset)
		if (reset == 1'b1) dffe7a[31:31] <= 1'b0;
		else if  (wire_dffe7a_ena[31:31] == 1'b1) 
			if (shift_reg_clear == 1'b1) dffe7a[31:31] <= 1'b0;
			else  dffe7a[31:31] <= ((~ shift_reg_load_enable) & shift_reg_serial_in);
	assign
		wire_dffe7a_ena = {32{((shift_reg_load_enable | shift_reg_shift_enable) | shift_reg_clear)}};
	// synopsys translate_off
	initial
		dffe8 = 0;
	// synopsys translate_on
	...
	assign
		...
		data_out = {((read_address & dffe7a[21]) | ((~ read_address) & dffe7a[31])), ((read_address & dffe7a[20]) | ((~ read_address) & dffe7a[30])), ((read_address & dffe7a[19]) | ((~ read_address) & dffe7a[29])), ((read_address & dffe7a[18]) | ((~ read_address) & dffe7a[28])), ((read_address & dffe7a[17]) | ((~ read_address) & dffe7a[27])), ((read_address & dffe7a[16]) | ((~ read_address) & dffe7a[26])), ((read_address & dffe7a[15]) | ((~ read_address) & dffe7a[25])), ((read_address & dffe7a[14]) | ((~ read_address) & dffe7a[24])), ((read_address & dffe7a[13]) | ((~ read_address) & dffe7a[23])), ((read_address & dffe7a[12]) | ((~ read_address) & dffe7a[22])), ((read_address & dffe7a[11]) | ((~ read_address) & dffe7a[21])), ((read_address & dffe7a[10]) | ((~ read_address) & dffe7a[20])), ((read_address & dffe7a[9]) | ((~ read_address) & dffe7a[19])), ((read_address & dffe7a[8]) | ((~ read_address) & dffe7a[18])), ((read_address & dffe7a[7]) | ((~ read_address) & dffe7a[17])), ((read_address & dffe7a[6]) | ((~ read_address) & dffe7a[16])), ((read_address & dffe7a[5]) | ((~ read_address) & dffe7a[15])), ((read_address & dffe7a[4]) | ((~ read_address) & dffe7a[14])), ((read_address & dffe7a[3]) | ((~ read_address) & dffe7a[13])), ((read_address & dffe7a[2]) | ((~ read_address) & dffe7a[12])), ((read_address & dffe7a[1]) | ((~ read_address) & dffe7a[11])), ((read_address & dffe7a[0]) | ((~ read_address) & dffe7a[10])), ((~ read_address) & dffe7a[9]), ((~ read_address) & dffe7a[8]), ((~ read_address) & dffe7a[7]), ((~ read_address) & dffe7a[6]), ((~ read_address) & dffe7a[5]), ((~ read_address) & dffe7a[4]), ((~ read_address) & dffe7a[3]), ((~ read_address) & dffe7a[2]), ((~ read_address) & dffe7a[1]), ((~ read_address) & dffe7a[0])},
		global_gnd = 1'b0,
		global_vcc = 1'b1,
		idle = idle_state,
		...
		w84w = (wire_cntr6_q ^ width_counter_param_width),
		width_counter_all_done = (((((wire_cntr6_q[0] & wire_cntr6_q[1]) & wire_cntr6_q[2]) & wire_cntr6_q[3]) & wire_cntr6_q[4]) & (~ wire_cntr6_q[5])),
		...
		width_counter_param_width_match = ((((((~ w84w[0]) & (~ w84w[1])) & (~ w84w[2])) & (~ w84w[3])) & (~ w84w[4])) & (~ w84w[5])),
		width_decoder_out = (((((((((((((((((((((({{4{1'b0}}, width_decoder_param_select[0], 1'b0} | {1'b0, {2{width_decoder_param_select[1]}}, {3{1'b0}}}) | {{4{1'b0}}, width_decoder_param_select[2], 1'b0}) | {1'b0, {3{width_decoder_param_select[3]}}, 1'b0, width_decoder_param_select[3]}) | {{5{1'b0}}, width_decoder_param_select[4]}) | {{4{1'b0}}, width_decoder_param_select[5], 1'b0}) | {1'b0, {2{width_decoder_param_select[6]}}, {3{1'b0}}}) | {{4{1'b0}}, width_decoder_param_select[7], 1'b0}) | {1'b0, {2{width_decoder_param_select[8]}}, {3{1'b0}}}) | {{3{1'b0}}, width_decoder_param_select[9], 1'b0, width_decoder_param_select[9]}) | {{4{1'b0}}, width_decoder_param_select[10], 1'b0}) | {1'b0, {2{width_decoder_param_select[11]}}, {3{1'b0}}}) | {{3{1'b0}}, width_decoder_param_select[12], 1'b0, width_decoder_param_select[12]}) | {{5{1'b0}}, width_decoder_param_select[13]}) | {{2{1'b0}}, {2{width_decoder_param_select[14]}}, {2{1'b0}}}) | {{5{1'b0}}, width_decoder_param_select[15]}) | {1'b0, width_decoder_param_select[16], 1'b0, {2{width_decoder_param_select[16]}}, 1'b0}) | {{5{1'b0}}, width_decoder_param_select[17]}) | {{5{1'b0}}, width_decoder_param_select[18]}) | {{2{1'b0}}, {2{width_decoder_param_select[19]}}, {2{1'b0}}}) | {{5{1'b0}}, width_decoder_param_select[20]}) | {1'b0, width_decoder_param_select[21], 1'b0, {2{width_decoder_param_select[21]}}, 1'b0}) | {{5{1'b0}}, width_decoder_param_select[22]}),
