...
Type
  ...
  TExecLineWA = class(TExecLineBase)
  private
    FBase       : word;
    FExt        : Cardinal;
    ...
    Function MsProcessExt ( ACmdCode : TWaCmdCode ) : boolean;
...
Const
  CExtLenList : array [TWaCmdCode] of byte =
   (
      0, // msccInvalid,
...
Constructor TExecLineWA.Create;
Begin
 Inherited;
End;

Destructor TExecLineWA.Destroy;
Begin
 Inherited;
End;
...
Procedure TExecLineWA.GetRowCol ( Const ASubdec : TMsSubdec; ATargIdx : TMsTargIdx; Out ARow, ACol : byte );
Begin
...
Procedure TExecLineWA.GetRowCol ( ATargIdx : TMsTargIdx; Out ARow, ACol : byte );
Begin
...
Function TExecLineWA.MsRegName ( ATargIdx : TMsTargIdx ) : string;
Var
  BRow,
  BCol      : byte;
Begin
...
Procedure TExecLineWA.GenCode ( Const AFormat : string );
Var
  BAsmLineS : string;
  BPos      : Integer;
Begin
...
Procedure TExecLineWA.CheckFixDstLabel;
Var
  BPos      : Integer;
Begin
 BPos:=0;
...
Function TExecLineWA.MsProcessExt ( ACmdCode : TWaCmdCode ) : boolean;
Var
  BExtLen   : byte;
Begin
 Result:=FALSE;
...
Function TExecLineWA.ConstDecBx : Cardinal;
Begin
...
Procedure TExecLineWA.MsSubdecARUC;
...
Procedure TExecLineWA.MsSubdecBM;
...
Procedure TExecLineWA.MsSubdecARRS;
...
Procedure TExecLineWA.MsSubdecBC;
...
Procedure TExecLineWA.MsSubdecBA;
...
Procedure TExecLineWA.MsSubdecMAID;
...
Procedure TExecLineWA.MsSubdecMARC;
...
Procedure TExecLineWA.MsSubdecONL;
...
Procedure TExecLineWA.MsSubdecIDE;
...
Procedure TExecLineWA.MsSubdecPEX;
...
Procedure TExecLineWA.MsSubdecAF;
...
Procedure TExecLineWA.MsSubdecREM;
...
Procedure TExecLineWA.MsSubdecPRCS;
...
Procedure TExecLineWA.MsSubdecSys;
// Sys    |10111   ||     ccc|10110001|                 | info siend silock siunlock siconf # # #
Begin
 FSubdec.FCccc:=(FBase shr 8) and $7;
End;

Procedure TExecLineWA.MsSubdecNTRE;
// NTRE   |10111   ||     ccc|10110010|                 | nop trap # # # # # #
Begin
 FSubdec.FCccc:=(FBase shr 8) and $7;
End;

Procedure TExecLineWA.MsSubdecPPL;
...
Procedure TExecLineWA.MsSubdecRFU;
// RFU    |10111   ||        |        |
Begin
End;

Procedure TExecLineWA.MsSubdecONS;
...
Procedure TExecLineWA.MsSubdecFRUC;
...
Procedure TExecLineWA.MsSubdecFRRS;
...
Procedure TExecLineWA.MsSubdecBTR;
...
Procedure TExecLineWA.MsSubdecBTM;
...
Procedure TExecLineWA.MsSubdecARUI;
...
Procedure TExecLineWA.MsSubdecARUS;
...
Begin
 ...
 repeat
 if Length(FCodeBin)<2 then begin FLastError:='eBinary data is too small [R:TExecLineWA.CmdDec]'; break; end;
...
// ONS    |110     ||   djjjj|jjjjffff|                 | sjmp jbe jc jnc jz jnz ja RFU jg jge js jse jn jv jnn jnv
// PRCS   |10111   ||     4cc|10110000|#2/4             | swt push_# 2xRFU
Function TExecLineWA.IsJmp : boolean;
Begin
...
Function TExecLineWA.IsJxx : boolean;
Begin
...
// PPL    |10111   ||     4cc|10110011|#2/4             | popl pushl 2xRFU leave enter 2xRFU (4 is set by natural way)
Function TExecLineWA.IsRet : boolean;
Begin
 Result:=((FSubdec.FCmdCode=msccPPL) and (FSubdec.FCccc in [0, 4]) and ((FSubdec.FConst and $1)<>0));
End;

Function TExecLineWA.IsCall : boolean;
Begin
 Result:=FALSE;
End;

Function TExecLineWA.IsDecStop : boolean;
Begin
 Result:=FSubdec.FCmdCode in [msccInvalid];
End;

Function TExecLineWA.CallOrJmp : TCallOrJmp;
Begin
 Result:=cjUnknown;
 repeat
