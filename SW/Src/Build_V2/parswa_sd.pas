...
Constructor TParsWA.Create;
Begin
 Inherited;
End;

Destructor TParsWA.Destroy;
Begin
 Inherited;
End;

Function TParsWA.SensCase ( Const ADataS : string ) : string;
Begin
 Result:=ADataS;
End;

Procedure TParsWA.RdTextFC ( AJmpNextLine : boolean );
Var
  BLastComment  : char;
Begin
 repeat
...
Procedure TParsWA.RdTextFD ( AJmpNextLine : boolean );
Var
  BDefineA,
  BDefineB      : string;
  BOutValid     : boolean;
...
Function TParsWA.IsReservedWord ( Const AName : string ) : boolean;
Begin
 Result:=FALSE;
End;

Function TParsWA.StrToOpcode ( Const AOpcodeS : string ) : string;
Begin
 Result:='';
...
Function TParsWA.IsTargConstant ( Const ANameS : string ) : string;
Var
  BNameS        : string;
  BDataC        : Cardinal;
  BDataF        : Extended;
...
Procedure TParsWA.Parse ( AModule : TLlvmModule; AIsInclude : boolean );
Var
  BFilePath,
  BFileName,
  BFileExt      : String;
