...
Type
  ...
  public
    ...
    Function SendData ( Const ADataBin : string ) : boolean; Virtual; Abstract;
    Function RecvByte ( Out AData : byte; ATimeOut : Cardinal ) : boolean; Virtual; Abstract;

    Function SendByte ( AData : byte ) : boolean;
...
Function TComPortBase.SendByte ( AData : byte ) : boolean;
Begin
 Result:=SendData(Chr(AData));
End;

Function TComPortBase.RecvByte ( Out AData : byte ) : boolean;
Begin
 Result:=RecvByte(AData,FTimeOut);
End;
